 ...
 *
 *	Demo Link: https://youtu.be/mCXTvGuAm3E
 */
#include <avr/io.h>
#ifdef _SIMULATE_
...
enum SM1_STATES{SM1_SMStart, SM1_zeroLight, SM1_oneLight, SM1_twoLight, SM1_threeLight, SM1_fourLight, SM1_fiveLight, SM1_sixLight, SM1_ReleaseOne, SM1_ReleaseTwo, SM1_ReleaseThree, SM1_ReleaseFour, SM1_ReleaseFive, SM1_ReleaseSix} SM1_STATE;
void Tick_LoHi() {
  switch(SM1_STATE) { 
    case SM1_SMStart:
